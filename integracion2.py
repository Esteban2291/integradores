#8 Vamos a definir ahora una “Cuenta Joven”, para ello vamos a crear una nueva clase CuantaJoven que deriva de la clase
# creada en el punto 7. Cuando se crea esta nueva clase, además del titular y la cantidad se debe guardar
...
# método es_titular_valido() que devuelve verdadero si el titular es mayor de edad pero menor de 25 años y falso en caso 
# contrario. 
...
class CuentaJoven(Cuenta):
    ...
    def esTitularValido(self):
        return self.titular.edad < 25 and self.titular()
